...
data_root = "/home/george-vengrovski/Documents/data/llb3_data_matrices"
train = "train"
test = "test"

processor = SpectrogramProcessor(data_root=data_root, train_dir=train, test_dir=test, n_clusters=100, train_prop=0.8)
