...
tweetyBERT_config_path = "/home/george-vengrovski/Documents/projects/tweety_bert_paper/experiments/1mask/config.json"
tweetyBERT_weight_path = "/home/george-vengrovski/Documents/projects/tweety_bert_paper/experiments/1mask/saved_weights/model_step_49995.pth"
...
model=model, 
device=device, 
data_dir="/home/george-vengrovski/Documents/data/llb11_data_matrices", 
subsample_factor=config['subsample'],  # Using new config parameter
remove_silences=False,  # Using new config parameter
samples=100, 
file_path="/home/george-vengrovski/Documents/projects/tweety_bert_paper/files/category_colors_llb11.pkl", 
layer_index=-1, 
dict_key="V", 
